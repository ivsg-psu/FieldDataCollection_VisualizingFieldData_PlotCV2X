...
title(sprintf('Figure %.0d: RSU locations for Site 1',fig_num), 'Interpreter','none');
...
title('Site 1 RSU coverage zones');
...
% Prep for animation
filename = 'fcn_plotCV2X_site1RSUs.gif';
flagFirstTime = 1;
