%% script_test_fcn_plotCV2X_findNearbyAngles
% This is a script to exercise the function:
% fcn_plotCV2X_findNearbyAngles.m
...
nearbyIndicies  = fcn_plotCV2X_findNearbyAngles(tENU, searchRadiusAndAngles, (fig_num));
title({sprintf('Example %.0d: showing fcn_plotCV2X_findNearbyAngles',fig_num), sprintf('File: %s',csvFile)}, 'Interpreter','none','FontSize',12);
...
% Test the function
[velocity, angleENUradians, compassHeadingDegrees]  = fcn_plotCV2X_findNearbyAngles(tLLA, tENU, modeIndex, offsetCentisecondsToMode, []);
sgtitle({sprintf('Example %.0d: showing fcn_plotCV2X_findNearbyAngles',fig_num), sprintf('File: %s',csvFile)}, 'Interpreter','none','FontSize',12);
...
% Test the function
[velocity, angleENUradians, compassHeadingDegrees]  = fcn_plotCV2X_findNearbyAngles(tLLA, tENU, modeIndex, offsetCentisecondsToMode, fig_num);
sgtitle({sprintf('Example %.0d: showing fcn_plotCV2X_findNearbyAngles',fig_num), sprintf('File: %s',csvFile)}, 'Interpreter','none','FontSize',12);
...
if 1==1
    fprintf(1,'\n\nComparison of fcn_plotCV2X_findNearbyAngles without speed setting (slow) and with speed setting (fast):\n');
