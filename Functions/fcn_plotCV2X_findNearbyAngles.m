function nearbyIndicies = fcn_plotCV2X_findNearbyAngles(anchorAngle, anglesToSearch, varargin)
%fcn_plotCV2X_findNearbyAngles  for each point, lists nearby indicies
%
% FORMAT:
%
